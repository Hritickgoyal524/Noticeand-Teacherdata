...
for(var i=0;i<data.length;i++){
  bn.add(data[i].innerHtml.replaceAll('<img src="images/new.gif" height="12">', ""));
}
var hr=bd[0]
...
void initState(){
  ...
  Widget build(BuildContext context){
    return Scaffold(
       ...
       appBar:AppBar(
        title:Text("Trainig And Placment office Notices",textAlign: TextAlign.right,),
        centerTitle: true,
        ),
        body:Container(
         ...
         InkWell(
           ...
           decoration: BoxDecoration(
            ...
            color: Colors.amber[200]
             ...
             child:
           Text(bn[index],style:TextStyle(color:Colors.black,fontSize:15,fontWeight: FontWeight.w800)
           )
           ),
           SizedBox(height:15)
           /*Card(child:
